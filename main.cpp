...
//Новая проблема: 
//мы откатились на 1 коммит назад, сделали новый коммит. А потом поняли, что удаленный коммит нам нужен.
...
//git reset --hard ORIG_HEAD ( или nomer_udalennogo_kommita) - восстанавливаем коммит
